...
public class RecycleViewAlbum extends RecyclerView.Adapter<RecycleViewAlbum.MyViewHolder>{

    private Context mContext;
    private List<UploadAlbum> uploads;

    public RecycleViewAlbum(Context mContext, List<UploadAlbum> uploads) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecycleViewAlbum.MyViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, ListAlbumSongActivity.class);
