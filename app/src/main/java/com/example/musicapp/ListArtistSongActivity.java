...
public class ListArtistSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_artist_song);
        ...
        valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(checkin){
                    ...
                    Toast.makeText(ListArtistSongActivity.this, "there is no songs!!", Toast.LENGTH_SHORT).show();
                }
            }
